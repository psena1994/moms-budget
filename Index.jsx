    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      >
        ...
        >
          <Sparkles size={20} />
          {cushion > 0
            ? `Wonderful â€” you've kept ${money(cushion)} safe this month!`
            : cushion === 0
            ? "You're right on track. Every dollar you save adds up."
            : "A little tight this month â€” let's find a small win on the next tab."}
        </div>
      </div>
              ...
              >
                ...
                {over && (
                  <div style={{ color: t.warn, fontSize: 15, marginTop: 6, fontWeight: 700 }}>
                    A little over budget here â€” no worry, just something to watch.
                  </div>
                )}
              </div>
            );
...
/* ============================================================
   VIEW B â€” HOURS & SAVINGS STRETCHER
   ============================================================ */
      ...
      <section style={cardBase}>
        ...
        <div style={{ marginBottom: 26 }}>
          <label style={{ fontSize: 19, fontWeight: 700, display: "block", marginBottom: 10 }}>
            If I work an extra <span style={{ color: t.accent }}>{extraHours} hours</span> this monthâ€¦
          </label>
        ...
        <div>
          <label style={{ fontSize: 19, fontWeight: 700, display: "block", marginBottom: 10 }}>
            â€¦and if I save an extra <span style={{ color: t.accent }}>{money(extraGroceries)}</span> on groceries.
          </label>
